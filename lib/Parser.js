...
const ELSE_IF_ATTR = ':elif';
const FOR_ATTR = ':for';
const FOR_ITEM_ATTR = ':for-item';
const FOR_ITEM_INDEX_ATTR = ':for-index';
...
function Parser(source) {
    ...
    function wrapElseStatement (element, statements, lastIfNode) {
        let elseIfValue = statements[ELSE_IF_ATTR];
    ...
    function wrapForStatement(element, statements) {
        let value = statements[FOR_ATTR];
        if (value) {
            return For(value, {
                item: statements[FOR_ITEM_ATTR],
                index: statements[FOR_ITEM_INDEX_ATTR],
            }, element);
        }
        return element;
    }
